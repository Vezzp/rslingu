...
\g__rslingu_color_codegen_cs:nn { suffix } { 7fdb6a }
\g__rslingu_color_codegen_cs:nn { prefix } { f44747 }
\g__rslingu_color_codegen_cs:nn { root } { eedc31 }
\g__rslingu_color_codegen_cs:nn { postfix } { 966842 }
\g__rslingu_color_codegen_cs:nn { ending } { 0e68ce }
\g__rslingu_color_codegen_cs:nn { base } { 990066 }
