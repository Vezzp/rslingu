...
\ExplSyntaxOn
    ...
    \cs_new_protected:Nn \l__rs_choose_color:n {
        \tl_set:Nn \l__rs_color { \bool_if:nTF { \RSColorBool || \l_rs_morphemes_color_bool || \l_rs_syntax_color_bool }{#1}{black} }
    }
...
\ExplSyntaxOn
    ...
    \NewDocumentCommand{\rsPrefix}{ O{} m }{
        \group_begin:
        \IfNoValueTF{#2}{}{
            \keys_set_known:nn { rs/morphemes/keys } { phantom=false, color=false, #1 }
    ...
    \NewDocumentCommand{\rsEnding}{ O{} m }{
        ...
        \tikz[baseline=(Root.base)]{
            ...
            \bool_if:nTF { \RSPhantomBool || \l_rs_morphemes_phantom_bool }
            {
                ...
                \node[RSCage] (Root) {\ifblank{#2}{\phantom{о}}{#2}\RSFullVPhantom};
            }
