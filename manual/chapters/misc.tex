...
suffix & { \color[HTML]{7fdb6a} 7fdb6a } & prefix & { \color[HTML]{f44747} f44747 }\\\midrule
root & { \color[HTML]{eedc31} eedc31 } & postfix & { \color[HTML]{966842} 966842 }\\\midrule
ending & { \color[HTML]{0e68ce} 0e68ce } & base & { \color[HTML]{990066} 990066 }
        \\\bottomrule
    \end{tabular}
...
\begin{table}[ht!]
    ...
    \begin{tabular}{@{}llll@{}}
        \hline
        Имя элемента & Код цвета & Имя элемента & Код цвета\\\midrule
subject & { \color[HTML]{673ab7} 673ab7 } & predicate & { \color[HTML]{e81e62} e81e62 }\\\midrule
attribute & { \color[HTML]{2196f3} 2196f3 } & adverbial & { \color[HTML]{009688} 009688 }\\\midrule
object & { \color[HTML]{ffa500} ffa500 }
        \\\bottomrule
    \end{tabular}
